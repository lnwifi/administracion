  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[700px] max-h-[95vh] overflow-y-auto">
          <DialogHeader className="space-y-2 sm:space-y-0">
            <DialogTitle className="text-xl sm:text-2xl">Detalles del Popup</DialogTitle>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[700px] max-h-[95vh] overflow-y-auto">
          <DialogHeader className="space-y-2 sm:space-y-0">
            <DialogTitle className="text-xl sm:text-2xl">Crear Nuevo Popup</DialogTitle>
            <DialogDescription className="text-sm sm:text-base">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[700px] max-h-[95vh] overflow-y-auto">
          <DialogHeader className="space-y-2 sm:space-y-0">
            <DialogTitle className="text-xl sm:text-2xl">Editar Popup</DialogTitle>
            <DialogDescription className="text-sm sm:text-base">
