...
import FreeTrialConfig from '@/components/FreeTrialConfig';
...
const ConfiguracionPage: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'promociones', label: 'Promociones', icon: <Gift className="w-4 h-4" /> }
  ];
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'promociones': return <FreeTrialConfig />;
